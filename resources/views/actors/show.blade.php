<x-app-layout title="Movie Cast - Detail Actor {{ $getActor['name'] }}">
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img src="{{ 'https://image.tmdb.org/t/p/w300/'.$getActor['profile_path'] }}" alt="example" class="w-76">
                <ul class="flex items-center mt-4">
                    ...
                    @endif
                    @if ($getActor['homepage'])
                        <li class="ml-6">
                            <a href="{{ $getActor ['homepage'] }}" title="Homepage">
            ...
            <div class="md:ml-24">
                <h2 class="text-4xl font-semibold">{{ $getActor['name'] }}</h2>
                <div class="flex flex-wrap items-center text-gray-400 text-sm mt-5">
                    ...
                    <span class="ml-2">{{ \Carbon\Carbon::parse($getActor['birthday'])->format('d F, Y') }} ({{ \Carbon\Carbon::parse($getActor['birthday'])->age }} years old) in {{ $getActor['place_of_birth'] }}</span>
                </div>
